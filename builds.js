...
// PUBLISHED list (GitHub): the live root index.html IS v5.5; v5.1 is the prior
// committed snapshot (index-v5.1.html); v5.2 / v5.3 / v5.4 / v6 / v7 are local-only
// and not published.
window.BUILDS = [
  { label: "v5.5", file: "index.html"      },
