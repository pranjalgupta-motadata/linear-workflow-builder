...
// PUBLISHED list (GitHub): the live root index.html IS v5.2; v5.1 is the prior
// snapshot (index-v5.1.html); v6 / v7 are local-only and not published.
window.BUILDS = [
  { label: "v5.2", file: "index.html"      },
